...
public class FirstPersonController : MonoBehaviour
{
    ...
    [SerializeField] private float regenRateTime = 1;
    ...
    private void HandleHeadbob()
    {
        ...
        if (Mathf.Abs(moveDirection.x) > 0.1f || Mathf.Abs(moveDirection.z) > 0.1f)
        {
            ...
            playerCamera.transform.localPosition = new Vector3(playerCamera.transform.localPosition.x, defaultYpos + Mathf.Sin(timer) * (isCrouching ? crouchHeadbobAmount : isSprinting ? sprintHeadbobAmount : walkHeadbobAmount), playerCamera.transform.localPosition.z);
        }
    }
    ...
    private void HandleInteractionInput()
    {
        ...
        {
            currentInteractable.OnInterect();
        }
    }
    ...
    private void ApplyDamage(float dmg)
    {
        ...
        regeneration = StartCoroutine(RegenerateHealth());
    }
    ...
    private IEnumerator RegenerateHealth()
    {
        ...
        WaitForSeconds timeToWait = new WaitForSeconds(regenRateTime);
